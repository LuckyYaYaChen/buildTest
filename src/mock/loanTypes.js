...
let dataKey = Mock.mock({
  'data|6': [
    {
      'id|+1': 1,
      fraudNumbr: '@string("number", 3, 3)',
      hackerNumbr: '@string("number", 2, 2)',
      riskNumbr: '@string("number", 2, 2)',
      creditNumbr: '@string("number", 2, 2)',
      'cooprName|1': [
        '长安新生',
        '宝马金融',
        '北汽金融',
...
module.exports = {
  ...
  'POST /api/loanTypes': function (req, res) {
  ...
  'DELETE /api/loanTypes': function (req, res) {
  ...
  'PUT /api/loanTypes': function (req, res) {
