  ...
  render () {
    ...
    return (
      <Input.Group compact size={size} className={styles.search} style={style}>
        {select && <Select size={{ size: 'default' }} className="selsect" getPopupContainer={() => document.getElementById('selectContainer')} style={{ minWidth: '25%', width, height: '32px!important' }} ref="searchSelect" onChange={this.handeleSelectChange} size={size} {...selectProps}>
